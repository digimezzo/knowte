export class CollectionEvents {
    public static readonly getIsInitializedEvent: string = '227ff3f1-ce6e-466e-84f2-8764ce7ef747';
    public static readonly getNoteDetailsEvent: string = 'db3595b0-0997-414e-a30e-c5921c8d9861';
    public static readonly saveNoteTitleEvent: string = 'd81c66b1-34f3-4b9d-9275-2aa6cee35201';
    public static readonly saveNoteTextEvent: string = '7188b946-484c-4b6e-89d3-3e8a16ff33cd';
    ...
    public static readonly setNotePinEvent: string = 'bfcbd741-0759-4941-9d7e-25429607308f';
    ...
    public static readonly notePinChangedEvent: string = '93bb68d3-7434-47f3-a7ac-561392c5d512';
    ...
    public static readonly closeAllNotesEvent: string = '32be88f2-21cf-463d-813a-461fa3363693';
}
