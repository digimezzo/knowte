...
export class Constants {
    ...
    static readonly fontSizeChangedEvent: string = 'e49b82b5-f960-49bf-83f8-9721edc386cb';
    static readonly languageChangedEvent: string = '0f8d004f-080d-4901-b813-477432809519';
    static readonly noteFontSizeChangedEvent: string = '6ec3f042-27ea-49e1-a012-49693f44db02';
